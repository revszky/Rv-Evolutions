...
const MenuVerticalW = ({ pilihMenu }: MenuNavProps) => {
    ...
    <div className="w-full flex items-start justify-between gap-32">
      <div className="flex flex-col items-start justify-center">
        {urutanMenu.map((menu, urutan) => (
          <Link
            ...
            className="font-mono font-bold text-sm text-white py-2"
          >
            {menu.judul}
          </Link>
        ))}
      ...
      <div className="relative">
        <button
          ...
          className="px-2 py-1.5 text-xs md:text-sm font-mono font-bold bg-white text-black"
        >
          CHECK ID
        </button>
